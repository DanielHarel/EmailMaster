...
var emailUser = mongoose_1.default.model('emailUsers');
...
passport_1.default.deserializeUser(function (id, done) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, emailUser.findById(id)];
            case 1:
                user = _a.sent();
                done(null, user);
                return [2 /*return*/];
...
passport_1.default.use(new passport_google_oauth20_1.Strategy({
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, emailUser.findOne({ googleId: profile.id })];
            case 1:
                existingUser = _a.sent();
                if (!existingUser) return [3 /*break*/, 2];
                done(null, existingUser);
                return [3 /*break*/, 4];
            case 2: return [4 /*yield*/, new emailUser({ googleId: profile.id }).save()];
            case 3:
                user = _a.sent();
                done(null, user);
                _a.label = 4;
