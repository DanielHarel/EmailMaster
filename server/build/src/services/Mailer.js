...
var Mailer = /** @class */ (function () {
    function Mailer(survey, content) {
        mail_1.default.setApiKey(keys_1.default.sendGridKey);
        //@ts-ignore
        this.msg = {
            to: survey.recipients.map(function (email) { return email; }),
    ...
    Mailer.prototype.send = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, mail_1.default.send(this.msg)];
                    case 1:
                        response = _a.sent();
